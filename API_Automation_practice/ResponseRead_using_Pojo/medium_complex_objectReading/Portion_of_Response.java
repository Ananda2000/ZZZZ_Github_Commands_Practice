...
public class Portion_of_Response 
{
	public static void main(String [] args) throws JsonParseException, JsonMappingException, IOException
	{
		...
		//Portion_of_response_pojo resp = objmpr.readValue(jsonresponse, Portion_of_response_pojo.class);
		
		JsonNode resp = objmpr.readTree(jsonresponse);
		JsonNode resp1 = resp.findPath("contractors");
		
		Portion_of_response_pojo jjj = objmpr.treeToValue(resp1, Portion_of_response_pojo.class);
